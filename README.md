...
```
cd existing_repo
git remote add origin https://git.openrainbow.org/zittel/rb-qa-dashboard.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.openrainbow.org/zittel/rb-qa-dashboard/-/settings/integrations)
